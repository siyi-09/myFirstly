    ...
    <td align="center" width="80%" class="td1">
     ...
     <table width="90%"  border="0">
      <tr align="center" height="10">
        ...
        <td width="30%" bgcolor="#99FF99">作者ID</td>
        <td width="25%" bgcolor="#99FF99">标题</td>
     ...
     <tr bgcolor="white" height="10">
       ...
       <td><s:property value="tuid"/></td>
       <td><s:property value="ttop"/></td>
       <td width="10%">
       <a href="selectTopicByItd?t.tid=<s:property value="tid"/>&&t.tuid=<s:property value="tuid"/>">查看</a></td>
       <td width="10%">
      <a href="adelTopic.action?t.tid=<s:property value="tid"/>">
      <img src="/firstly1_3/images/sc21.png" width="23" height="23"></img></a>
       </td>
    </tr>
    </s:iterator>
  </table>
